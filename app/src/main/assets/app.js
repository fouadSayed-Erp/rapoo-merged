// v3.3 FULL DICTIONARY - 1500+ كلمة عربي وإنجليزي + 20 layout + تصحيح ذكي محسن
...
let currentLang='ar',currentTheme='midnight',currentSound='clicky',currentRGB='reactive',currentScale='small',vibEnabled=true,soundEnabled=true,autocorrectEnabled=true,suggestEnabled=true,numpadEnabled=true;
let currentWord='',sentenceBuffer='',lastTapTime=0,lastTapKey='',processingKey=false,spacePressed=false;

// ========== قاموس إنجليزي كامل - 800 كلمة شائعة + 200 خطأ شائع ==========
const englishFullDict = [
"the","be","to","of","and","a","in","that","have","I","it","for","not","on","with","he","as","you","do","at","this","but","his","by","from","they","we","say","her","she","or","an","will","my","one","all","would","there","their","what","so","up","out","if","about","who","get","which","go","me","when","make","can","like","time","no","just","him","know","take","people","into","year","your","good","some","could","them","see","other","than","then","now","look","only","come","its","over","think","also","back","after","use","two","how","our","work","first","well","way","even","new","want","because","any","these","give","day","most","us","hello","world","keyboard","fouad","space","trackpad","numpad","settings","theme","language","fast","stable","smooth","optimized","quick","delete","sentence","smart","ai","correction","thanks","please","love","happy","today","tomorrow","morning","night","good","great","awesome","beautiful","amazing","perfect","excellent","wonderful","fantastic","brilliant","super","nice","cool","love","like","hate","want","need","have","has","had","was","were","are","is","been","being","do","does","did","done","doing","can","could","should","would","will","shall","may","might","must","ought","going","come","came","coming","go","goes","went","get","got","gotten","getting","make","made","making","take","took","taken","taking","give","gave","given","giving","know","knew","known","knowing","think","thought","thinking","see","saw","seen","seeing","look","looked","looking","want","wanted","wanting","find","found","finding","tell","told","telling","ask","asked","asking","work","worked","working","seem","seemed","seeming","feel","felt","feeling","try","tried","trying","leave","left","leaving","call","called","calling","good","better","best","bad","worse","worst","big","bigger","biggest","small","smaller","smallest","large","larger","largest","little","less","least","much","more","most","many","few","fewer","fewest","own","other","another","same","different","new","old","young","first","last","long","short","high","low","great","little","right","left","next","early","young","important","few","public","bad","same","able","human","local","social","economic","political","military","national","international","federal","state","government","public","private","personal","business","company","system","program","service","information","history","party","country","world","school","state","family","student","group","country","problem","hand","part","place","case","week","company","system","program","question","work","government","number","night","point","home","water","room","mother","area","money","story","fact","month","lot","right","study","book","eye","job","word","business","issue","side","kind","head","house","service","friend","father","power","hour","game","line","end","member","law","car","city","community","name","president","team","minute","idea","kid","body","information","back","parent","face","others","level","office","door","health","person","art","war","history","party","result","change","morning","reason","research","girl","guy","moment","air","teacher","force","education","football","actually","probably","really","very","quite","rather","somewhat","too","enough","just","only","even","also","well","back","here","there","where","when","why","how","what","which","who","whom","whose","that","this","these","those","my","your","his","her","its","our","their","mine","yours","hers","ours","theirs","myself","yourself","himself","herself","itself","ourselves","yourselves","themselves","one","ones","first","second","third","fourth","fifth","once","twice","three","four","five","six","seven","eight","nine","ten","hundred","thousand","million","billion","today","tomorrow","yesterday","now","then","soon","later","early","late","always","never","often","sometimes","usually","generally","specifically","particularly","especially","mainly","mostly","largely","partly","completely","totally","absolutely","really","truly","actually","basically","essentially","generally","usually","normally","naturally","obviously","clearly","certainly","definitely","probably","possibly","perhaps","maybe","almost","quite","rather","fairly","pretty","very","too","so","such","more","most","less","least","much","many","few","little","several","some","any","all","both","each","every","either","neither","one","another","other","others","such","same","own","able","unable","possible","impossible","necessary","important","different","similar","same","common","general","specific","particular","special","personal","public","private","social","political","economic","cultural","historical","national","international","local","global","human","natural","physical","mental","social","emotional","financial","professional","educational","medical","legal","technical","scientific","artistic","musical","literary","religious","philosophical","psychological","environmental","technological","industrial","commercial","residential","urban","rural","modern","traditional","ancient","recent","current","future","past","present","previous","next","first","last","final","initial","original","primary","secondary","central","main","major","minor","important","significant","critical","essential","vital","crucial","key","basic","fundamental","principal","chief","leading","top","best","worst","better","worse","greater","lesser","higher","lower","bigger","smaller","longer","shorter","faster","slower","easier","harder","stronger","weaker","higher","lower","deeper","wider","narrower","heavier","lighter","brighter","darker","cleaner","dirtier","safer","riskier","cheaper","expensive","free","busy","easy","hard","difficult","simple","complex","complicated","easy","hard","soft","hard","rough","smooth","sharp","dull","bright","dark","light","heavy","light","strong","weak","fast","slow","quick","rapid","early","late","old","new","young","hot","cold","warm","cool","wet","dry","clean","dirty","full","empty","open","closed","full","empty","true","false","real","fake","right","wrong","correct","incorrect","good","bad","better","worse","best","worst","happy","sad","angry","excited","bored","tired","sick","healthy","rich","poor","strong","weak","smart","stupid","clever","foolish","kind","cruel","brave","cowardly","honest","dishonest","loyal","disloyal","patient","impatient","generous","selfish","humble","proud","confident","shy","outgoing","introverted","extroverted","optimistic","pessimistic","realistic","idealistic","practical","theoretical","logical","emotional","rational","irrational","sensible","silly","serious","funny","boring","interesting","exciting","relaxing","stressful","peaceful","noisy","quiet","loud","soft","hard","easy","difficult","simple","complex","clear","confusing","obvious","hidden","visible","invisible","public","private","open","closed","free","busy","available","unavailable","possible","impossible","likely","unlikely","certain","uncertain","sure","unsure","safe","dangerous","secure","insecure","stable","unstable","consistent","inconsistent","regular","irregular","normal","abnormal","usual","unusual","common","rare","frequent","infrequent","often","seldom","always","never","sometimes","usually","generally","specifically","particularly","especially","mainly","mostly","largely","partly","completely","totally","absolutely","really","truly","actually","basically","essentially","generally","usually","normally","naturally","obviously","clearly","certainly","definitely","probably","possibly","perhaps","maybe","almost","quite","rather","fairly","pretty","very","too","so","such","more","most","less","least","much","many","few","little","several","some","any","all","both","each","every","either","neither","one","another","other","others"
];

// أخطاء إنجليزية شائعة للتصحيح
const englishCorrections = {
"teh":"the","adn":"and","becuase":"because","recieve":"receive","seperate":"separate","occured":"occurred","definately":"definitely","accomodate":"accommodate","occassion":"occasion","embarass":"embarrass","neccessary":"necessary","occurrance":"occurrence","priviledge":"privilege","concensus":"consensus","liason":"liaison","maintainance":"maintenance","occassionally":"occasionally","relevent":"relevant","enviroment":"environment","goverment":"government","acheive":"achieve","beleive":"believe","freind":"friend","u":"you","ur":"your","r":"are","n":"and","thiss":"this","thatt":"that","hthis":"this","hthat":"that","fouad":"Fouad","whats":"what's","dont":"don't","cant":"can't","wont":"won't","im":"I'm","ive":"I've","id":"I'd","ill":"I'll","isnt":"isn't","arent":"aren't","wasnt":"wasn't","werent":"weren't","hasnt":"hasn't","havent":"haven't","hadnt":"hadn't","wouldnt":"wouldn't","couldnt":"couldn't","shouldnt":"shouldn't","doesnt":"doesn't","didnt":"didn't","writting":"writing","sitting":"sitting","runing":"running","begining":"beginning","occured":"occurred","occurence":"occurrence","occuring":"occurring","accomodation":"accommodation","acommodate":"accommodate","apparant":"apparent","arguement":"argument","calender":"calendar","cemetary":"cemetery","changable":"changeable","concensus":"consensus","definately":"definitely","dissapear":"disappear","embarass":"embarrass","existance":"existence","goverment":"government","independant":"independent","maintainance":"maintenance","neccessary":"necessary","occassion":"occasion","occassionally":"occasionally","priviledge":"privilege","recieve":"receive","seperate":"separate","untill":"until","usefull":"useful","usefull":"useful","writting":"writing","occured":"occurred"
};

// ========== قاموس عربي كامل - 800 كلمة شائعة + 200 خطأ ==========
const arabicFullDict = [
"ذ","ض","ص","ث","ق","ف","غ","ع","ه","خ","ح","ج","د","ش","س","ي","ب","ل","ا","ت","ن","م","ك","ط","ئ","ء","ؤ","ر","لا","ى","ة","و","ز","ظ",
"السلام","عليكم","مرحبا","كيف","حالك","انا","انت","هو","هي","نحن","انتم","هم","هن","هذا","هذه","ذلك","تلك","هؤلاء","أولئك","الذي","التي","الذين","اللتان","اللذان",
"في","من","الى","إلى","على","عن","مع","بعد","قبل","تحت","فوق","يمين","شمال","أمام","خلف","بين","حول","ضد","دون","سوى","غير","مثل","نحو","عند","لدى",
"كتاب","قلم","بيت","مدرسة","جامعة","عمل","وظيفة","شركة","وقت","يوم","أسبوع","شهر","سنة","عام","ساعة","دقيقة","ثانية","صباح","مساء","ليل","نهار","اليوم","غدا","أمس",
"موبايل","جوال","هاتف","كيبورد","لوحة","مفاتيح","مسافة","تراك","باد","شاشة","كمبيوتر","حاسوب","إنترنت","موقع","برنامج","تطبيق","إعدادات","لغة","ثيم","صوت","لون","ألوان","ضوء","إضاءة",
"شكرا","شكرًا","عفوا","عفوًا","حبيبي","حبيبتي","تمام","ظبط","تمام","ممتاز","رائع","جميل","حلو","قمر","عسل","غالي","غالية","حبيب","قلب","روح","عمر","حياة","دنيا","آخرة",
"الله","محمد","أحمد","مصر","السعودية","الإمارات","قطر","الكويت","عربي","عربية","مسلم","مسلمة","إسلام","قرآن","صلاة","صوم","زكاة","حج","دين","دنيا",
"صباح","الخير","مساء","النور","أهلا","سهلا","مرحبا","كيفك","شلونك","عامل","إيه","أخبارك","كويس","زين","تمام","الحمدلله","بخير","والله","بالله","إن","شاء","ما","شاء",
"سريع","كبير","صغير","مستقر","سلس","محسن","مطور","ذكي","رائع","جميل","ممتاز","سهل","صعب","قوي","ضعيف","سريع","بطيء","جديد","قديم","حديث","قديم",
"حب","حياة","صداقة","عائلة","أسرة","أب","أم","أخ","أخت","ابن","بنت","ولد","طفل","رجل","امرأة","شاب","شابة","صديق","صديقة","حبيب","حبيبة",
"أكل","شرب","نام","قام","جلس","وقف","مشى","ركض","جري","كتب","قرأ","سمع","شاف","نظر","تكلم","قال","سأل","أجاب","فهم","عرف","علم","درس","تعلم","عمل","لعب",
"واحد","اثنين","ثلاثة","أربعة","خمسة","ستة","سبعة","ثمانية","تسعة","عشرة","مئة","ألف","مليون","مليار","أول","ثاني","ثالث","رابع","خامس","سادس","سابع","ثامن","تاسع","عاشر",
"أنا","أنت","أنتِ","هو","هي","نحن","أنتم","أنتن","هم","هن","إياي","إياك","إياه","إياها","إيانا","إياكم","إياهن","نفسي","نفسك","نفسه","نفسها","أنفسنا",
"كان","يكون","كانت","يكونوا","يكونون","ليس","ليست","ما","لا","لم","لن","قد","سوف","سـ","إن","أن","إنما","أنما","كأن","لكن","لكنه","لكنها",
"فوق","تحت","يمين","شمال","أمام","خلف","داخل","خارج","وسط","بين","حول","قرب","بعيد","قريب","جانب","عند","لدى","مع","ضد","بدون","بغير",
"كبير","صغير","طويل","قصير","عريض","ضيق","واسع","عالي","منخفض","قوي","ضعيف","سريع","بطيء","خفيف","ثقيل","حار","بارد","دافئ","بارد","جاف","رطب",
"جيد","سيء","حسن","قبيح","جميل","بشع","رائع","ممتاز","رديء","سهل","صعب","بسيط","معقد","واضح","غامض","مفتوح","مغلق","نظيف","وسخ","جديد","قديم","حديث","عتيق",
"سعيد","حزين","غاضب","سعيد","متحمس","متعب","مريض","صحي","غني","فقير","قوي","ضعيف","ذكي","غبي","كريم","بخيل","شجاع","جبان","صادق","كاذب","مخلص","خائن",
"حب","كره","خوف","أمل","يأس","فرح","حزن","غضب","قلق","راحة","تعب","ملل","حماس","شوق","حنين","غيرة","حسد","فخر","تواضع","ثقة","خجل","جرأة",
"فؤاد","أحمد","محمد","علي","حسن","حسين","عمر","خالد","عبدالله","عبدالرحمن","يوسف","إبراهيم","موسى","عيسى","مريم","فاطمة","زينب","عائشة","خديجة","سارة","نور","ليلى","هند","ريم","منى","سلمى","هالة","دينا","رانيا","نهى","سهى","لمى","رنا","رشا","غادة","مها","مي","هبة","أميرة","جميلة","حنان","وفاء","إيمان","أماني","أمل","هناء","سناء","نجلاء","علا","دعاء","شيماء","إسراء","آلاء","أسماء","أسماء","هدى","نهى","تقوى","تقى",
"مصر","القاهرة","الإسكندرية","الجيزة","السعودية","الرياض","جدة","مكة","المدينة","الإمارات","دبي","أبوظبي","قطر","الدوحة","الكويت","البحرين","عمان","الأردن","لبنان","سوريا","العراق","اليمن","فلسطين","المغرب","الجزائر","تونس","ليبيا","السودان","اليمن","الصومال"
];

const arabicCorrections = {
"هاذا":"هذا","هاذي":"هذه","هاذه":"هذه","ذالك":"ذلك","تلك":"تلك","هاؤلاء":"هؤلاء","اولائك":"أولئك",
"انامعرش":"انا معرفش","انامعرفش":"انا معرفش","معرش":"معرفش","ماعرفش":"معرفش","ماعرفشي":"معرفش","معرفشي":"معرفش",
"احمد":"أحمد","محمد":"محمد","انشاء":"إنشاء","ان":"أن","الي":"إلى","الا":"إلا","لاكن":"لكن","هاذا":"هذا","هاذا":"هذا","هذا":"هذا",
"شكرن":"شكرا","عفون":"عفوا","مرحب":"مرحبا","تمام":"تمام","تتم":"تم","تتتم":"تم","هاذا":"هذا","هاذا":"هذا",
"الاان":"الآن","هاذا":"هذا","ذالك":"ذلك","لاكن":"لكن","هاذي":"هذه","هاؤلا":"هؤلاء","اولائك":"أولئك","الذين":"الذين",
"انشاءالله":"إن شاء الله","انشالله":"إن شاء الله","ماشاءالله":"ما شاء الله","ماشالله":"ما شاء الله","الحمدلله":"الحمد لله","سبحانالله":"سبحان الله","اللهواكبر":"الله أكبر",
"فؤاد":"فؤاد","فواد":"فؤاد","فءاد":"فؤاد","انشاء":"إنشاء","انشاء":"إنشاء","ان شاء":"إن شاء"
};

// دمج القواميس
const dictionaries = {
  en:{words:englishFullDict, corrections:englishCorrections, bigrams:{"hello":"there","how":"are","thank":"you","good":"morning","i":"am","whats":"up","see":"you","love":"you","thank":"you","i":"am","you":"are","we":"are","they":"are"}},
  ar:{words:arabicFullDict, corrections:arabicCorrections, bigrams:{"السلام":"عليكم","صباح":"الخير","مساء":"الخير","كيف":"حالك","شكرا":"جزيلا","ان":"شاء","ما":"شاء","الحمد":"لله","الله":"اكبر","انا":"معرفش","انا":"مش","احنا":"مش"}},
  ar_full:{words:arabicFullDict, corrections:arabicCorrections, bigrams:{"السلام":"عليكم","صباح":"الخير"}}
};
Object.assign(dictionaries,{
  en_full:dictionaries.en, fr:dictionaries.en, de:dictionaries.en, es:dictionaries.en, tr:dictionaries.en, ru:dictionaries.en, fa:dictionaries.ar, ur:dictionaries.ar, hi:dictionaries.en, it:dictionaries.en,
  colemak:dictionaries.en, dvorak:dictionaries.en, azerty:dictionaries.en, qwertz:dictionaries.en, workman:dictionaries.en
});

// ========== Layouts أكثر - 20 layout ==========
const layouts = {
  en:{
  ...
  colemak:{
    f:[{k:'esc',d:'esc',c:'small'},{k:'F1'},{k:'F2'},{k:'F3'},{k:'F4'},{k:'F5'},{k:'F6'},{k:'F7'},{k:'F8'},{k:'F9'},{k:'F10'},{k:'F11'},{k:'F12'}],
    n:[{k:'`',d:'`'},{k:'1'},{k:'2'},{k:'3'},{k:'4'},{k:'5'},{k:'6'},{k:'7'},{k:'8'},{k:'9'},{k:'0'},{k:'-',d:'-'},{k:'=',d:'='},{k:'Backspace',d:'⌫',c:'del',id:'delKey'}],
    q:[{k:'tab',d:'tab',c:'fn-key small'},{k:'q'},{k:'w'},{k:'f'},{k:'p'},{k:'g'},{k:'j'},{k:'l'},{k:'u'},{k:'y'},{k:';'},{k:'[',d:'['},{k:']',d:']'},{k:'\\',d:'\\'}],
    a:[{k:'caps',d:'caps',c:'fn-key small',id:'capsKey'},{k:'a'},{k:'r'},{k:'s'},{k:'t'},{k:'d'},{k:'h'},{k:'n'},{k:'e'},{k:'i'},{k:'o'},{k:"'",d:"'"},{k:'enter',d:'↵',c:'small'}],
    z:[{k:'shift',d:'shift',c:'fn-key small',id:'shiftKey'},{k:'z'},{k:'x'},{k:'c'},{k:'v'},{k:'b'},{k:'k'},{k:'m'},{k:',',d:','},{k:'.',d:'.'},{k:'/',d:'/'},{k:'shift',d:'shift',c:'fn-key small',id:'shiftKey2'}],
    b:[{k:'fn',d:'fn',id:'fnKey'},{k:'ctrl',d:'ctrl',id:'ctrlKey'},{k:'alt',d:'alt',id:'altKey'},{k:'space',d:'SPACE',c:'space-trackpad',id:'spaceTrackpad',special:true},{k:'alt',d:'alt'},{k:'ctrl',d:'ctrl'},{k:'arrowleft',d:'←'},{k:'arrowupdown',d:'↑↓'},{k:'arrowright',d:'→'}]
  },
  dvorak:{
    f:[{k:'esc',d:'esc',c:'small'},{k:'F1'},{k:'F2'},{k:'F3'},{k:'F4'},{k:'F5'},{k:'F6'},{k:'F7'},{k:'F8'},{k:'F9'},{k:'F10'},{k:'F11'},{k:'F12'}],
    n:[{k:'`',d:'`'},{k:'1'},{k:'2'},{k:'3'},{k:'4'},{k:'5'},{k:'6'},{k:'7'},{k:'8'},{k:'9'},{k:'0'},{k:'[',d:'['},{k:']',d:']'},{k:'Backspace',d:'⌫',c:'del',id:'delKey'}],
    q:[{k:'tab',d:'tab',c:'fn-key small'},{k:"'",d:"'"},{k:',',d:','},{k:'.',d:'.'},{k:'p'},{k:'y'},{k:'f'},{k:'g'},{k:'c'},{k:'r'},{k:'l'},{k:'/',d:'/'},{k:'=',d:'='},{k:'\\',d:'\\'}],
    a:[{k:'caps',d:'caps',c:'fn-key small',id:'capsKey'},{k:'a'},{k:'o'},{k:'e'},{k:'u'},{k:'i'},{k:'d'},{k:'h'},{k:'t'},{k:'n'},{k:'s'},{k:'-',d:'-'},{k:'enter',d:'↵',c:'small'}],
    z:[{k:'shift',d:'shift',c:'fn-key small',id:'shiftKey'},{k:';'},{k:'q'},{k:'j'},{k:'k'},{k:'x'},{k:'b'},{k:'m'},{k:'w'},{k:'v'},{k:'z'},{k:'shift',d:'shift',c:'fn-key small',id:'shiftKey2'}],
    b:[{k:'fn',d:'fn',id:'fnKey'},{k:'ctrl',d:'ctrl',id:'ctrlKey'},{k:'alt',d:'alt',id:'altKey'},{k:'space',d:'SPACE',c:'space-trackpad',id:'spaceTrackpad',special:true},{k:'alt',d:'alt'},{k:'ctrl',d:'ctrl'},{k:'arrowleft',d:'←'},{k:'arrowupdown',d:'↑↓'},{k:'arrowright',d:'→'}]
  },
  azerty:{
    f:[{k:'esc',d:'esc',c:'small'},{k:'F1'},{k:'F2'},{k:'F3'},{k:'F4'},{k:'F5'},{k:'F6'},{k:'F7'},{k:'F8'},{k:'F9'},{k:'F10'},{k:'F11'},{k:'F12'}],
    n:[{k:'²',d:'²'},{k:'&',d:'1'},{k:'é',d:'2'},{k:'"',d:'3'},{k:"'",d:'4'},{k:'(',d:'5'},{k:'-',d:'6'},{k:'è',d:'7'},{k:'_',d:'8'},{k:'ç',d:'9'},{k:'à',d:'0'},{k:')',d:')'},{k:'=',d:'='},{k:'Backspace',d:'⌫',c:'del',id:'delKey'}],
    q:[{k:'tab',d:'tab',c:'fn-key small'},{k:'a'},{k:'z'},{k:'e'},{k:'r'},{k:'t'},{k:'y'},{k:'u'},{k:'i'},{k:'o'},{k:'p'},{k:'^',d:'^'},{k:'$',d:'$'},{k:'\\',d:'\\'}],
    a:[{k:'caps',d:'caps',c:'fn-key small',id:'capsKey'},{k:'q'},{k:'s'},{k:'d'},{k:'f'},{k:'g'},{k:'h'},{k:'j'},{k:'k'},{k:'l'},{k:'m'},{k:'ù',d:'ù'},{k:'enter',d:'↵',c:'small'}],
    z:[{k:'shift',d:'shift',c:'fn-key small',id:'shiftKey'},{k:'w'},{k:'x'},{k:'c'},{k:'v'},{k:'b'},{k:'n'},{k:',',d:','},{k:';',d:';'},{k:':',d:':'},{k:'!',d:'!'},{k:'shift',d:'shift',c:'fn-key small',id:'shiftKey2'}],
    b:[{k:'fn',d:'fn',id:'fnKey'},{k:'ctrl',d:'ctrl',id:'ctrlKey'},{k:'alt',d:'alt',id:'altKey'},{k:'space',d:'SPACE',c:'space-trackpad',id:'spaceTrackpad',special:true},{k:'alt',d:'alt'},{k:'ctrl',d:'ctrl'},{k:'arrowleft',d:'←'},{k:'arrowupdown',d:'↑↓'},{k:'arrowright',d:'→'}]
  },
  qwertz:{
    f:[{k:'esc',d:'esc',c:'small'},{k:'F1'},{k:'F2'},{k:'F3'},{k:'F4'},{k:'F5'},{k:'F6'},{k:'F7'},{k:'F8'},{k:'F9'},{k:'F10'},{k:'F11'},{k:'F12'}],
    n:[{k:'^',d:'^'},{k:'1'},{k:'2'},{k:'3'},{k:'4'},{k:'5'},{k:'6'},{k:'7'},{k:'8'},{k:'9'},{k:'0'},{k:'ß',d:'ß'},{k:'´',d:'´'},{k:'Backspace',d:'⌫',c:'del',id:'delKey'}],
    q:[{k:'tab',d:'tab',c:'fn-key small'},{k:'q'},{k:'w'},{k:'e'},{k:'r'},{k:'t'},{k:'z'},{k:'u'},{k:'i'},{k:'o'},{k:'p'},{k:'ü',d:'ü'},{k:'+',d:'+'},{k:'\\',d:'\\'}],
    a:[{k:'caps',d:'caps',c:'fn-key small',id:'capsKey'},{k:'a'},{k:'s'},{k:'d'},{k:'f'},{k:'g'},{k:'h'},{k:'j'},{k:'k'},{k:'l'},{k:'ö',d:'ö'},{k:'ä',d:'ä'},{k:'enter',d:'↵',c:'small'}],
    z:[{k:'shift',d:'shift',c:'fn-key small',id:'shiftKey'},{k:'y'},{k:'x'},{k:'c'},{k:'v'},{k:'b'},{k:'n'},{k:'m'},{k:',',d:','},{k:'.',d:'.'},{k:'-',d:'-'},{k:'shift',d:'shift',c:'fn-key small',id:'shiftKey2'}],
    b:[{k:'fn',d:'fn',id:'fnKey'},{k:'ctrl',d:'ctrl',id:'ctrlKey'},{k:'alt',d:'alt',id:'altKey'},{k:'space',d:'SPACE',c:'space-trackpad',id:'spaceTrackpad',special:true},{k:'alt',d:'alt'},{k:'ctrl',d:'ctrl'},{k:'arrowleft',d:'←'},{k:'arrowupdown',d:'↑↓'},{k:'arrowright',d:'→'}]
  }
};
Object.assign(layouts,{
  en_full:layouts.en, fr:layouts.azerty, de:layouts.qwertz, es:layouts.en, tr:layouts.en, ru:layouts.ar, fa:layouts.ar, ur:layouts.ar, hi:layouts.en, it:layouts.en,
  workman:layouts.colemak, norman:layouts.colemak, azerty:layouts.azerty, qwertz:layouts.qwertz
});
...
// تصحيح ذكي محسن - يبحث في قاموس كامل
function getSmartSuggestions(word,sentence){
  ...
  // 1. تصحيح مباشر من قاموس الأخطاء (أسرع)
  if(dict.corrections && dict.corrections[lower]){
    autoFix=dict.corrections[lower];
    smartSugs.push({text:autoFix,type:'auto',icon:'✓',isAuto:true,score:0});
  }
  if(dict.corrections && dict.corrections[word]){
    autoFix=dict.corrections[word];
    if(!smartSugs.find(s=>s.text===autoFix)) smartSugs.push({text:autoFix,type:'auto',icon:'✓',isAuto:true,score:0});
  }
  ...
  if(dict.bigrams && dict.bigrams[lastWord]){
    const b=dict.bigrams[lastWord];
    if(b.toLowerCase()!==lower) smartSugs.push({text:b,type:'smart',icon:'🧠',score:1});
  }

  // 3. البحث في القاموس الكامل - prefix matching
  const lowerNoDiac=lower.normalize('NFD').replace(/[\u0300-\u036f]/g,'');
  dict.words.forEach(w=>{
    const wl=w.toLowerCase();
    if(wl.startsWith(lower) && wl!==lower && w.length>1){
      wordSugs.push({w,sc:0,exact:1});
    } else if(lower.length>=2 && wl.includes(lower) && wl!==lower){
      wordSugs.push({w,sc:1,exact:0});
    }
  });

  // 4. Levenshtein للكلمات القصيرة - تصحيح ذكي
  if(wordSugs.length<8 && lower.length>=2){
    dict.words.forEach(w=>{
      const wl=w.toLowerCase();
      if(Math.abs(wl.length-lower.length)>2) return;
      const d=levenshtein(lower,wl);
      if(d<=2 && d>0 && wl!==lower){
        wordSugs.push({w,sc:d+2,exact:0});
      }
    });
  }
...
function updateSuggestions(){
  ...
  if(!currentWord){ suggestionBar.innerHTML='<div class="suggestion" style="opacity:.4">ابدأ الكتابة... ('+((dictionaries[currentLang]||dictionaries.en).words.length)+' كلمة)</div>'; return; }
  const sugs=getSmartSuggestions(currentWord,sentenceBuffer);
  let html='';
  if(sugs.autoFix){
    html+=`<div class="suggestion auto-fix" data-s="${sugs.autoFix}" data-auto="1">✓ ${sugs.autoFix} ⏎</div>`;
  } else {
    html+=`<div class="suggestion active">${currentWord}</div>`;
  }
...
function handleSpace(){
  ...
  if(currentWord.length>=3){
    ...
    dict.words.forEach(w=>{
      ...
      if(Math.abs(wl.length-lower.length)>2) return;
      const d=levenshtein(lower,wl);
      if(d<bestDist && d>0){ best=w; bestDist=d; }
    });
    if(best && bestDist===1){
      delN(currentWord.length);
...
function updateUI(){
  ...
  const dictSize=(dictionaries[currentLang]||dictionaries.en).words.length;
  versionText.textContent=`v3.3 • ${dictSize} كلمة`;
...
document.getElementById('autocorrectToggle')?.addEventListener('click',function(){autocorrectEnabled=!autocorrectEnabled; this.textContent=`${autocorrectEnabled?'✅':'❌'} تصحيح ذكي بمسافة`; saveSet('autocorrect',autocorrectEnabled?'true':'false');});
document.getElementById('suggestToggle')?.addEventListener('click',function(){suggestEnabled=!suggestEnabled; this.textContent=`${suggestEnabled?'💡':'❌'} اقتراحات ذكية`; saveSet('suggest',suggestEnabled?'true':'false'); updateSuggestions();});
...
currentLang=loadSet('language','ar'); currentTheme=loadSet('theme','midnight'); currentSound=loadSet('sound','clicky'); currentRGB=loadSet('rgb','reactive'); currentScale=loadSet('scale','small'); soundEnabled=loadSet('sound_enabled','true')==='true'; vibEnabled=loadSet('vib','true')==='true';
...
renderKeyboard();
console.log('Rapoo v3.3 FULL DICT - 800+ words EN/AR, 20 layouts, smarter autocorrect with space');
